...
export const getAudioContext = (): AudioContext => {
  ...
  // If not initialized and suspended, try to resume
...
// Export initialization function for user interaction
  ...
  marimba: {
    layers: [
      { frequency: 1, type: "sine", gain: 0.9 },
      {
        ...
        type: "triangle",
        gain: 0.4,
        envelope: { decay: 0.4, sustain: 0.1 },
      },
    ],
    masterEnvelope: {
      attack: 0.004,
  ...
  piano: {
    layers: [
      { frequency: 1, type: "triangle", gain: 0.9 },
      {
        ...
        type: "sine",
        gain: 0.4,
        envelope: { decay: 0.5, sustain: 0.2 },
      },
    ],
    masterEnvelope: {
      attack: 0.005,
  ...
  "guitar-clean": {
    layers: [
      ...
      },
      {
        ...
        type: "sine",
        gain: 0.15,
        envelope: { decay: 0.2, sustain: 0.05 },
      },
    ],
    masterEnvelope: {
      attack: 0.008,
  ...
  "guitar-distorted": {
    layers: [
      ...
      { frequency: 1.01, type: "square", gain: 0.6, detune: -12 },
      {
        ...
        type: "sawtooth",
        gain: 0.3,
        envelope: { decay: 0.4, sustain: 0.2 },
      },
    ],
    masterEnvelope: {
      attack: 0.005,
  ...
  bass: {
    layers: [
      { frequency: 1, type: "sawtooth", gain: 0.9 },
      {
        ...
        type: "square",
        gain: 0.6,
        envelope: { decay: 0.3, sustain: 0.4 },
      },
      {
        frequency: 2,
        type: "triangle",
        gain: 0.2,
        envelope: { decay: 0.15, sustain: 0.1 },
      },
    ],
    masterEnvelope: {
      attack: 0.01,
  ...
  "synth-lead": {
    layers: [
      ...
      { frequency: 1.005, type: "sawtooth", gain: 0.8, detune: 5 },
      {
        ...
        type: "square",
        gain: 0.4,
        envelope: { decay: 0.2, sustain: 0.3 },
      },
    ],
    masterEnvelope: {
      attack: 0.02,
  ...
  "synth-pad": {
    layers: [
      ...
      { frequency: 0.5, type: "triangle", gain: 0.5 },
      {
        ...
        type: "sine",
        gain: 0.3,
        envelope: { decay: 0.4, sustain: 0.6 },
      },
    ],
    masterEnvelope: {
      attack: 0.3,
  ...
  bells: {
    layers: [
      { frequency: 1, type: "sine", gain: 0.8 },
      {
        ...
        type: "sine",
        gain: 0.6,
        envelope: { decay: 0.3, sustain: 0.2 },
      },
      {
        frequency: 5.4,
        type: "sine",
        gain: 0.4,
        envelope: { decay: 0.2, sustain: 0.1 },
      },
      {
        frequency: 8.93,
        type: "sine",
        gain: 0.25,
        envelope: { decay: 0.15, sustain: 0.05 },
      },
    ],
    masterEnvelope: {
      attack: 0.002,
  ...
  strings: {
    layers: [
      ...
      { frequency: 1.01, type: "sawtooth", gain: 0.7, detune: 4 },
      {
        ...
        type: "triangle",
        gain: 0.4,
        envelope: { decay: 0.3, sustain: 0.5 },
      },
      {
        frequency: 3,
        type: "sine",
  ...
  flute: {
    layers: [
      { frequency: 1, type: "sine", gain: 0.9 },
      {
        ...
        type: "triangle",
        gain: 0.3,
        envelope: { decay: 0.2, sustain: 0.4 },
      },
      {
        frequency: 3,
        type: "sine",
        gain: 0.15,
        envelope: { decay: 0.15, sustain: 0.2 },
      },
    ],
    masterEnvelope: {
      attack: 0.05,
  ...
  brass: {
    layers: [
      { frequency: 1, type: "sawtooth", gain: 0.8 },
      {
        ...
        type: "square",
        gain: 0.5,
        envelope: { decay: 0.2, sustain: 0.6 },
      },
      {
        frequency: 3,
        type: "triangle",
        gain: 0.3,
        envelope: { decay: 0.15, sustain: 0.4 },
      },
      {
        frequency: 4,
        type: "sine",
        gain: 0.2,
        envelope: { decay: 0.1, sustain: 0.2 },
      },
    ],
    masterEnvelope: {
      attack: 0.03,
...
const createReverb = (
  ...
  for (let channel = 0; channel < 2; channel++) {
    ...
    for (let i = 0; i < length; i++) {
      ...
      channelData[i] =
        (Math.random() * 2 - 1) * decay * Math.pow(1 - i / length, 2);
    }
  }
...
const createDistortion = (
  ...
  for (let i = 0; i < samples; i++) {
    ...
    curve[i] =
      ((3 + config.drive) * x * 20 * deg) /
      (Math.PI + config.drive * Math.abs(x));
  }
...
const synthesizeSound = (
  ...
  config.layers.forEach((layer) => {
    ...
    const layerEnvelope = {
      ...
      ...layer.envelope,
      attackLevel:
        (layer.envelope?.attackLevel ?? config.masterEnvelope.attackLevel) *
        layer.gain,
    };
  ...
  const cleanupDelayMs = Math.max(
    0,
    (startTime + duration - ctx.currentTime) * 1000 + 200,
  );
  window.setTimeout(() => {
